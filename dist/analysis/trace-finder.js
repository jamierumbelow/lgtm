 ...
 */
export async function findTraces(files, options) {
    const matches = [];
...
async function searchClaudeHistory(claudeDir, filePaths) {
    const matches = [];
...
async function analyzeClaudeSession(sessionPath, filePaths) {
    try {
...
async function searchCursorHistory(cursorDir, filePaths) {
    const matches = [];
